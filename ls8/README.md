...
* cpu.py - starter code for CPU class with helpful methods
* ls8.py - Creates an instance of CPU, loads instructions, and runs it.
* examples folder - Sample instructions for different operations.
* ams folder - Contains .asm source.
